...
from T3UI import Ui_MainWindow
...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.image_arr = [self.image1, self.image2]
    ...
    def mix_images(self):
        ...
        outputText = self.ui.comboBox_output.currentText() #to know this will apply to the first or secound output 
        component1ComponentText = self.ui.component1_component_comboBox.currentText() #to know the first componant  
        component1ImageText = self.ui.component1_image_comboBox.currentText() #to know the first componant source 
        component2ComponentText = self.ui.component2_component_comboBox.currentText()#to know the first componant
        component2ImageText = self.ui.component2_image_comboBox.currentText()#to know the first componant source 
        if (
                outputText == "Choose output 1 or 2" or component1ComponentText == "choose component" or component1ImageText == "Choose image 1 or 2" or component2ComponentText == "choose component" or component2ImageText == "Choose image 1 or 2"):
            self.show_popup("fill all comboboxes")
            return  
        #the next few lines to check the the user choose the componant and its husband 
        if ((component1ComponentText == "Magnitude" and component2ComponentText != "Phase") and (
                component1ComponentText == "Magnitude" and component2ComponentText != "Uni_Phase")):
            self.show_popup("you cannot mix by these components")
            return
        elif ((component1ComponentText == "Phase" and component2ComponentText != "Magnitude") and (
                component1ComponentText == "Phase" and component2ComponentText != "Uni_Mag")):
            self.show_popup("you cannot mix by these components")
            return
        elif ((component1ComponentText == "Uni_Mag" and component2ComponentText != "Phase") and (
                component1ComponentText == "Uni_Mag" and component2ComponentText != "Uni_Phase")):
            self.show_popup("you cannot mix by these components")
            return
        elif ((component1ComponentText == "Uni_Phase" and component2ComponentText != "Magnitude") and (
                component1ComponentText == "Uni_Phase" and component2ComponentText != "Uni_Mag")):
            self.show_popup("you cannot mix by these components")
            return
        if (component1ComponentText == "Real" and component2ComponentText != "Imag"):
            ...
            #this for store the data in two mixing arrayes 
        ...
        #this for check the first componant coming from imge 1 or imge 2?
        ...
        output = imageClass.mixTwoImages(self.image_arr[0], self.image_arr[1], percentage_of_component1_image1,
                                         percentage_of_component2_image1, component1Enum, component2Enum)
    ...
    def Browse(self, i):#get the 
        ...
        print("#this give me the pixle color fron 0 to 255 of the first pixle and thecound one")
        print((self.image_arr[0].image_arr[0][0]))#this give me the pixle color fron 0 to 255 of the first pixle and thecound one
        if (len(self.image_arr[0].image_arr) == len(self.image_arr[1].image_arr) or len(
                self.image_arr[0].image_arr) == 0 or len(self.image_arr[1].image_arr) == 0):
    ...
    def showComponents(self, i):
        #this functio for graph the the compont of image 1 and 2 independantly  
